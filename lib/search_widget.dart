...
typedef DynamicListCallback<T> = void Function(T item);
...
class SearchWidget<T> extends StatefulWidget {
  ...
  final DynamicListCallback dynamicListCallback;
...
class MySingleChoiceSearchState<T> extends State<SearchWidget<T>> {
  ...
  void onDropDownItemTap(T item) {
    ...
    widget.dynamicListCallback(widget.selectedItemBuilder(item, null));
  }
